...
class Train():
    ...
    def start(self, profile_name, actions, headsetId='INSIGHT2-A3D20368'):
        """
...
def main():
    ...
    profile_name = 'kyleSIM' # set your profile name. If the profile is not exited it will be created.
