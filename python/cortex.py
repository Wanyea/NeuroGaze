...
class Cortex(Dispatcher):
    ...
    def __init__(self, client_id, client_secret, debug_mode=False, **kwargs):
        ...
        self.session_id = ''
        self.headset_id = 'INSIGHT2-A3D20368'
        self.debug = debug_mode
        self.debit = 10
        self.license = '3b3a318f-7686-4303-93f7-ef1d012e47f8'
    ...
    def request_access(self):
        ...
        request_access_request = {
            ...
            "params": {
                "clientId": "ZVB8dyW0Hy29quBcLnYkSMG1ZD2piJ3slWwHYiz7", 
                "clientSecret": "OBKmO3Ppd7dymE4PCtmUC8yJQMY5qKBCkrKQAMwd8QxTQT4jZU5Sqiv24VRQsXlprXa4KAF5boxH5Tsak6WB4TK1IyiIqSwxKoZWZKK1fZCgV54T51aZbufvSDcr75eJ"
            },
