...
Shader "Unlit/ParallaxVFX"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_SubSurfaceScale("SubSurface Scale", Float) = 1
		_ParallaxScale("Parallax Scale", Range( -1 , 10)) = 0
		_SubSurfaceTexture("Sub Surface Texture", 2D) = "white" {}
		_Surface("Surface", 2D) = "white" {}
		_SpherizeStrenght("Spherize Strenght", Float) = -4
		[ASEEnd]_1("1", Float) = -4
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord8 = inputMesh.ase_texcoord.xy * temp_cast_0 + temp_cast_1;
				...
				float2 paralaxOffset5 = ParallaxOffset( 0 , _ParallaxScale , ase_tanViewDir );
				float2 vertexToFrag1 = ( texCoord8 + paralaxOffset5 );
				o.ase_texcoord1.zw = vertexToFrag1;
				float2 temp_cast_2 = (_SubSurfaceScale).xx;
				float temp_output_49_0 = ( _ParallaxScale * 0.5 );
				float2 temp_cast_3 = (( 0.5 * ( 1.0 - temp_output_49_0 ) )).xx;
				float2 texCoord39 = inputMesh.ase_texcoord.xy * temp_cast_2 + temp_cast_3;
				float2 paralaxOffset40 = ParallaxOffset( 0 , temp_output_49_0 , ase_tanViewDir );
				float2 vertexToFrag27 = ( texCoord39 + paralaxOffset40 );
				o.ase_texcoord2.xy = vertexToFrag27;
				float2 temp_cast_4 = (_SubSurfaceScale).xx;
				float temp_output_50_0 = ( temp_output_49_0 * 0.5 );
				float2 temp_cast_5 = (( 0.5 * ( 1.0 - temp_output_50_0 ) )).xx;
				float2 texCoord45 = inputMesh.ase_texcoord.xy * temp_cast_4 + temp_cast_5;
				float2 paralaxOffset46 = ParallaxOffset( 0 , temp_output_50_0 , ase_tanViewDir );
				float2 vertexToFrag28 = ( texCoord45 + paralaxOffset46 );
				o.ase_texcoord2.zw = vertexToFrag28;
					...
					)
			{
				...
				float2 uv_Surface = packedInput.ase_texcoord1.xy * _Surface_ST.xy + _Surface_ST.zw;
				float4 tex2DNode19 = tex2D( _Surface, uv_Surface );
				float2 temp_cast_0 = (0.1).xx;
				float2 vertexToFrag1 = packedInput.ase_texcoord1.zw;
				float2 temp_output_2_0_g3 = vertexToFrag1;
				...
				float2 temp_cast_2 = (_1).xx;
				float2 panner59 = ( 1.0 * _Time.y * temp_cast_0 + ( temp_output_2_0_g3 + ( temp_output_11_0_g3 * ( dotResult12_g3 * dotResult12_g3 * temp_cast_1 ) ) + temp_cast_2 ));
				float2 vertexToFrag27 = packedInput.ase_texcoord2.xy;
				float2 temp_cast_3 = (-0.1).xx;
				float2 vertexToFrag28 = packedInput.ase_texcoord2.zw;
				float2 panner61 = ( 1.0 * _Time.y * temp_cast_3 + vertexToFrag28);
				float4 temp_output_20_0 = ( tex2DNode19 * ( ( tex2D( _SubSurfaceTexture, panner59 ) * 0.33 ) + ( tex2D( _SubSurfaceTexture, vertexToFrag27 ) * 0.33 ) + ( tex2D( _SubSurfaceTexture, panner61 ) * 0.33 ) ) );
				
				surfaceDescription.Color = temp_output_20_0.rgb;
				surfaceDescription.Emission = temp_output_20_0.rgb;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Surface = packedInput.ase_texcoord.xy * _Surface_ST.xy + _Surface_ST.zw;
				float4 tex2DNode19 = tex2D( _Surface, uv_Surface );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 temp_cast_0 = (_SubSurfaceScale).xx;
				float2 temp_cast_1 = (( 0.5 * ( 1.0 - _SubSurfaceScale ) )).xx;
				float2 texCoord8 = inputMesh.uv0.xy * temp_cast_0 + temp_cast_1;
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.ase_tangent.xyz);
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float ase_vertexTangentSign = inputMesh.ase_tangent.w * ( unity_WorldTransformParams.w >= 0.0 ? 1.0 : -1.0 );
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
				...
				float2 paralaxOffset5 = ParallaxOffset( 0 , _ParallaxScale , ase_tanViewDir );
				float2 vertexToFrag1 = ( texCoord8 + paralaxOffset5 );
				o.ase_texcoord2.zw = vertexToFrag1;
				float2 temp_cast_2 = (_SubSurfaceScale).xx;
				float temp_output_49_0 = ( _ParallaxScale * 0.5 );
				float2 temp_cast_3 = (( 0.5 * ( 1.0 - temp_output_49_0 ) )).xx;
				float2 texCoord39 = inputMesh.uv0.xy * temp_cast_2 + temp_cast_3;
				float2 paralaxOffset40 = ParallaxOffset( 0 , temp_output_49_0 , ase_tanViewDir );
				float2 vertexToFrag27 = ( texCoord39 + paralaxOffset40 );
				o.ase_texcoord3.xy = vertexToFrag27;
				float2 temp_cast_4 = (_SubSurfaceScale).xx;
				float temp_output_50_0 = ( temp_output_49_0 * 0.5 );
				float2 temp_cast_5 = (( 0.5 * ( 1.0 - temp_output_50_0 ) )).xx;
				float2 texCoord45 = inputMesh.uv0.xy * temp_cast_4 + temp_cast_5;
				float2 paralaxOffset46 = ParallaxOffset( 0 , temp_output_50_0 , ase_tanViewDir );
				float2 vertexToFrag28 = ( texCoord45 + paralaxOffset46 );
				o.ase_texcoord3.zw = vertexToFrag28;
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Surface = packedInput.ase_texcoord2.xy * _Surface_ST.xy + _Surface_ST.zw;
				float4 tex2DNode19 = tex2D( _Surface, uv_Surface );
				float2 temp_cast_0 = (0.1).xx;
				float2 vertexToFrag1 = packedInput.ase_texcoord2.zw;
				float2 temp_output_2_0_g3 = vertexToFrag1;
				float2 temp_output_11_0_g3 = ( temp_output_2_0_g3 - float2( 0.5,0.5 ) );
				float dotResult12_g3 = dot( temp_output_11_0_g3 , temp_output_11_0_g3 );
				float2 temp_cast_1 = (_SpherizeStrenght).xx;
				float2 temp_cast_2 = (_1).xx;
				float2 panner59 = ( 1.0 * _Time.y * temp_cast_0 + ( temp_output_2_0_g3 + ( temp_output_11_0_g3 * ( dotResult12_g3 * dotResult12_g3 * temp_cast_1 ) ) + temp_cast_2 ));
				float2 vertexToFrag27 = packedInput.ase_texcoord3.xy;
				float2 temp_cast_3 = (-0.1).xx;
				float2 vertexToFrag28 = packedInput.ase_texcoord3.zw;
				float2 panner61 = ( 1.0 * _Time.y * temp_cast_3 + vertexToFrag28);
				float4 temp_output_20_0 = ( tex2DNode19 * ( ( tex2D( _SubSurfaceTexture, panner59 ) * 0.33 ) + ( tex2D( _SubSurfaceTexture, vertexToFrag27 ) * 0.33 ) + ( tex2D( _SubSurfaceTexture, panner61 ) * 0.33 ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Surface = packedInput.ase_texcoord3.xy * _Surface_ST.xy + _Surface_ST.zw;
				float4 tex2DNode19 = tex2D( _Surface, uv_Surface );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;11;169,28;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;13;Unlit/ParallaxVFX;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;638327685823712581;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
Node;AmplifyShaderEditor.SamplerNode;19;-628,-170.2999;Inherit;True;Property;_Surface;Surface;3;0;Create;True;0;0;0;False;0;False;-1;None;18fb255c3f249724bbf226ca456e8f1f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-216,-49.29993;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexToFragmentNode;1;-1030.333,90.25555;Inherit;False;False;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;10;-640,194.7001;Inherit;True;Property;_SubSurfaceTexture;Sub Surface Texture;2;0;Create;True;0;0;0;False;0;False;-1;None;cd3121832cb952443bf9a5a3335540ed;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;30;-611,826.7;Inherit;True;Property;_TextureSample1;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;10;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;29;-617,507.7001;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;10;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-221,839.7;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;8;-1495.333,-61.74445;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;2;-1193.333,90.25555;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-1745.833,1421.866;Inherit;False;2;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;45;-1498.833,1289.866;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;47;-1914.833,1406.866;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;48;-1196.833,1441.866;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-2163.117,1513.215;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-485,401.7;Inherit;False;Constant;_Float2;Float 2;5;0;Create;True;0;0;0;False;0;False;0.33;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexToFragmentNode;27;-1172,360.7001;Inherit;False;False;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;56;-934.4761,248.9632;Inherit;True;Spherize;-1;;3;1488bb72d8899174ba0601b595d32b07;0;4;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-198,248.7;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-244,511.7;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;36;-72,449.7;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-1178.576,462.1631;Inherit;False;Property;_SpherizeStrenght;Spherize Strenght;4;0;Create;True;0;0;0;False;0;False;-4;0.82;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;-1160.808,552.7495;Inherit;False;Property;_1;1;5;0;Create;True;0;0;0;False;0;False;-4;3.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;58;-1133.808,269.7495;Inherit;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-996.1479,698.0436;Inherit;False;Constant;_Float1;Float 1;6;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;59;-829.1479,596.0436;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;61;-953.1479,859.0436;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-1140.148,951.0436;Inherit;False;Constant;_Float3;Float 3;6;0;Create;True;0;0;0;False;0;False;-0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-2743.333,285.2556;Inherit;False;Property;_ParallaxScale;Parallax Scale;1;0;Create;True;0;0;0;False;0;False;0;3.56;-1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-2602.333,-43.74445;Inherit;False;Property;_SubSurfaceScale;SubSurface Scale;0;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;6;-2159.333,33.25555;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-1979.333,7.255547;Inherit;False;2;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;9;-2300.333,386.2556;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ParallaxOffsetHlpNode;5;-2090.333,268.2556;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;41;-1993.833,725.8666;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-1793.833,700.8666;Inherit;False;2;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;39;-1636.833,653.8666;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;42;-1354.833,682.8666;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;37;-1940.833,949.8668;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ParallaxOffsetHlpNode;40;-1730.833,831.8668;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-2300.117,745.2145;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;43;-1786.833,1614.867;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.VertexToFragmentNode;28;-1013,1319.7;Inherit;True;False;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ParallaxOffsetHlpNode;46;-1564.833,1548.867;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT2;0
WireConnection;11;0;20;0
WireConnection;11;1;20;0
WireConnection;11;2;19;4
...
ASEEND*/
//CHKSM=41F8754E0EF9701EA6E7F4330C0135FE0729BCAB