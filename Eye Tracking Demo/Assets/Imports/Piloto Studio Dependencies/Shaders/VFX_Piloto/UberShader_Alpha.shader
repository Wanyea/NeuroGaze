...
Shader "Piloto Studio/Alpha Uber Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult42_g119 = clamp( i.uv2_texcoord2.x , 0.0001 , ( totalFrames39_g119 - 1.0 ) );
			...
			float clampResult42_g118 = clamp( i.uv2_texcoord2.x , 0.0001 , ( totalFrames39_g118 - 1.0 ) );
			...
			float2 temp_output_15_0_g118 = ( ( ( LocalUVOffset184 + uvs_AlphaOverride.xy ) / appendResult7_g118 ) + ( floor( ( appendResult8_g118 * appendResult29_g118 ) ) / appendResult7_g118 ) );
...
ASEEND*/
//CHKSM=EEC499E0EFCEFDD9C9FAEE1A2E174C1FCB86988C